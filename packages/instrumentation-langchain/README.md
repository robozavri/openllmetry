...
```bash
npm install --save @ai-analytic-hub/instrumentation-langchain
```
...
} = require("@ai-analytic-hub/instrumentation-langchain");
...
[npm-url]: https://www.npmjs.com/package/@ai-analytic-hub/instrumentation-langchain
