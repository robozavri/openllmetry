...
```bash
npm install --save @ai-analytic-hub/instrumentation-chromadb
```
...
} = require("@ai-analytic-hub/instrumentation-chromadb");
...
[npm-url]: https://www.npmjs.com/package/@ai-analytic-hub/instrumentation-chromadb
