...
```bash
npm install --save @ai-analytic-hub/instrumentation-qdrant
```
...
const { QdrantInstrumentation } = require("@ai-analytic-hub/instrumentation-qdrant");
...
[npm-url]: https://www.npmjs.com/package/@ai-analytic-hub/instrumentation-qdrant
